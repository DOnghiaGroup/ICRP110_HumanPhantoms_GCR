...
public:
	...
	std::map<std::pair<G4String, G4double>, std::map<G4String, G4int>> GetTotalSecondaryFlux();
private:
	G4int nEvent;
	G4int totalDoseID;
	G4int organNameID;
	...
	G4THitsMap<G4String>* eventSecondaries;
	...
	std::map<std::pair<G4String, G4double>, std::map<G4String, G4int>> totalSecondaryFlux;
};
